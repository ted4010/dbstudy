...
CREATE TABLE MEMBER_T (
        ...
        MEM_POINT NUMBER, 
        MEM_GUBUN VARCHAR2(7 BYTE) NOT NULL CHECK(MEM_GUBUN = 'REGULAR' OR MEM_GUBUN = 'SOCIAL'),
...
ALTER TABLE MEMBER_T ADD MEM_ADDRESS VARCHAR2(200 BYTE);
...
ALTER TABLE BOARD_T ADD CONSTRAINT FK_BOARD_MEMBER FOREIGN KEY (MEM_ID)
    REFERENCES MEMBER_T(MEM_ID) ON DELETE CASCADE;
